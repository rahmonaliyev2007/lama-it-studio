...
const projectsData = [
  { image: aqua, alt: 'aqua site lama-it-studio', bg: 'linear-gradient(150deg, #3d3d3d, #6bb0ff58)', title:'B2bshop', link:"", desc:"Компания занимается оптовой торговлей. Мы разработали для неё удобный и адаптивный сайт с каталогом и формой заявки."},
  { image: b2b, alt: 'b2b site lama-it-studio', bg: 'linear-gradient(120deg, #6BB0FF80, #FFFFFF78)', title:'Aqua Evolution', link:"", desc:"Компания занимается продажей оборудования для очистки воды. Мы создали для неё информативный сайт с каталогом, описанием технологий и онлайн-заявкой."},
