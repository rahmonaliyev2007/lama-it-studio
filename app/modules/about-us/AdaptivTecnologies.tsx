...
const AdaptivTecnologies = () => {
  ...
  return (
    <div ref={ref} className='w-full !pb-1 max-[1200px]:hidden max-md:block relative aspect-square max-h-[400px] border-[#4E4C4C] border-[1px] rounded-[30px] p-[20px] shadow-[0 0 5.6px 0 #FFFFFF 15%] overflow-hidden group '>
      ...
      <div className={`flex items-center gap-[40px] min-w-[120%] translate-x-[3%] duration-1000 ${animate ? '!translate-x-[-15%]' : 'group-hover:translate-x-[-15%]'} bottom-1/3 absolute`}>
      ...
      <div className={`flex items-center gap-[40px] min-w-[120%] translate-x-[-15%] duration-1000 ${animate ? '!translate-x-[3%]' : 'group-hover:translate-x-[3%]'} bottom-10 absolute`}>
