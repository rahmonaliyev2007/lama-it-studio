    ...
    <div id='about'>
      <div>
        <div className="relative z-[20]">
          ...
          <h2 className="font-medium text-[#747474] text-xl max-[768px]:text-[14px] max-[900px]:text-lg m-auto text-center py-4 relative z-[20] bg-black">Топ кампании которые доверились нам</h2>
        </div>
        <Marquee />
      </div>
