    ...
    return (
        <div ref={ref} className={`w-full relative aspect-square max-h-[400px] border-[#4E4C4C] border-[1px] rounded-[30px] p-[20px] shadow-[0 0 5.6px 0 #FFFFFF 15%] overflow-hidden group `}>
            ...
            <div className='!p-10 max-[1100px]:!p-7'>
                <h3 className='font-semibold text-2xl max-[1100px]:text-xl text-white'>Про дизайнеры</h3>
                <p className='font-semibold text-[15px] text-[#969696] !mt-[14px] max-[1100px]:!mt-[5px] max-[1100px]:text-[13px]'>мы создаем высококачественные цифровые решения, которые выглядят великолепно и работают еще лучше</p>
            </div>
            ...
            <div className={`absolute -bottom-[15%] left-1/2 -translate-x-1/2 z-10 max-[1200px]:scale-[0.8]`}>
                <LamaIconCircle />
            </div>
