...
const Logo = () => {
    return (
        <div className={`text-[24px] text-white font-bold flex items-end gap-1 cursor-pointer group leading-[100%] relative`}> <Image src={logo} width={30} height={30} alt='lama logo' />
